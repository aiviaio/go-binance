...
import (
	...
	"github.com/aiviaio/go-binance/v2/delivery"
...
const (
	...
	SymbolFilterBySideTypePercentPrice SymbolFilterType = "PERCENT_PRICE_BY_SIDE"
...
// NewSubAccountDepositHistoryService Get Sub Account Deposit History
...
// NewSubAccountTransferFuturesHistoryService Query Sub Account Transfer History（FUTURES）
...
// NewBrokerFuturesRebateService Query Broker Futures Commission Rebate Record
func (c *Client) NewBrokerFuturesRebateService() *BrokerFuturesRebateService {
	return &BrokerFuturesRebateService{c: c}
}
